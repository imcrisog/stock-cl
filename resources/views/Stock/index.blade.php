    ...
    <div class="w-full md:w-[95%] my-1 md:my-2 md:m-4 mb-0 flex flex-row justify-center md:justify-between items-center fixed">
        ...
        <section class="flex flex-row gap-x-2 items-center w-full md:w-1/2 justify-center ">
            ...
            <div class="flex-inline items-center text-gray-900 font-medium w-full">
                    <form action="{{route('stocks.index', request()->search);}}" class="grid grid-cols-2 md:flex" method="post" id="searchForm">
                        <div class="[&>*]:rounded-md [&>*]:md:py-2 [&>*]:md:px-4 [&>*]:text-center gap-x-2 w-fit ">
                        ...
                        <button type="submit" class="md:px-4 border-2 rounded-lg border-rose-500 text-gray-300 font-extrabold transform duration-200 hover:scale-95 active:scale-75 active:bg-rose-400">BUSCAR</button>
                    </form>
            </div>
        </section>
        @if ($role->id <= 2)

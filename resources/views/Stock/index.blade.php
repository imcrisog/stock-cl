...
@section('content')
<div class="m-6 w-full h-full flex bg-slate-800 rounded-md flex-col z-[1]">
        ...
        <tbody>
            ...
            <tr class="border-b-[1px] border-slate-500">
                ...
                <td class="w-1/6 h-full inline-flex items-center justify-center space-x-2 py-2">
                    ...
                    <a href="{{ route('stocks.destroy', $stock->id) }}" class="border-2 border-red-500 transform duration-100 hover:bg-red-500 rounded-md px-2 py-2">
